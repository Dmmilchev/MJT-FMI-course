...
public interface PlotAPI<E extends Buildable> {
     ...
     */
    void construct(String address, E buildable) throws BuildableAlreadyExistsException, InsufficientPlotAreaException;
     ...
     */
    void constructAll(Map<String, E> buildables) throws IllegalArgumentException, BuildableAlreadyExistsException, InsufficientPlotAreaException;
     ...
     */
    void demolish(String address) throws IllegalArgumentException, BuildableNotFoundException;
